"""
time.time() will return the current time in seconds since
...
Given the above information, complete the code exercise by printing out
the speed it takes to run the fast_function() vs the slow_function().
...
def speed_calc_decorator(func):
    def wrapper_function():
        ...
        func()
        stop = time.time()
        print(f"{func.__name__} run speed: {stop - start}s")
